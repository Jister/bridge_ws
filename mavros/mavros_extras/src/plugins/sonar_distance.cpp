...
public:
    ...
    void initialize(UAS &uas_){
    	...
    	sonar_distance_sub = sonar_distance_nh.subscribe("/sonar_send",2,&SonarDistancePlugin::sonar_distance_send_cb,this);
...
private:
    ...
    //callbacks
    void sonar_distance_send_cb(const mavros_extras::SonarDistance &msg){
